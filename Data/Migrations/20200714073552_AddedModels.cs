        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortDestription = table.Column<string>(maxLength: 150, nullable: false),
                    PhotoURL = table.Column<string>(nullable: true),
                    SocialmediaList = table.Column<string>(nullable: true),
                    ListingTypeId = table.Column<int>(nullable: false),
                    DateAdded = table.Column<DateTime>(nullable: false),
                    IsVisible = table.Column<bool>(nullable: false),
                    IsAddedBySelf = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
